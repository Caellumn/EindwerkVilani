...
class EditBooking extends EditRecord
{
    ...
    protected function beforeSave(): void
    {
        ...
        if ($overlappingBookings->count() > 0) {
            ...
            Notification::make()
                ...
                ->body('This booking conflicts with existing bookings for the same gender. Review the details below and use "Yes, Update Anyway" to proceed.')
                ->persistent()
                ->send();
    ...
    protected function getFormActions(): array
    {
        ...
        $actions[] = Actions\Action::make('confirmOverlap')
            ...
            ->modalSubmitActionLabel('Yes, Update Anyway')
